...
from backbone.fourierft import FourierFT_ViT_timm
...
def get_backbone(args, pretrained=False):
    ...
    if name == "pretrained_vit_b16_224" or name == "vit_base_patch16_224":
        ...
        n_frequency = args["fourierft"]["n_frequency"]  # 替换rank为n_frequency
        # 使用FourierFT_ViT_timm替换LoRA_ViT_timm
        model = FourierFT_ViT_timm(
            ...
            round_number=args.get('round_number', 0),
            reinit_num=args.get('reinit_num', 0),
            indices_file_path=args.get('indices_file_path', None)
        )
        model.out_dim = 768
        return model
